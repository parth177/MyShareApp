...
{
    public static final String ACTION_CHOOSE_DIRECTORY = "com.com.abc.mxcloneshare.intent.action.CHOOSE_DIRECTORY";
    public static final String ACTION_CHOOSE_FILE = "com.com.abc.mxcloneshare.intent.action.CHOOSE_FILE";
