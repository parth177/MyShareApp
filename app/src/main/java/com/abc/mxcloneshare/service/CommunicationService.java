...
import com.abc.mxcloneshare.base.Keyword;
import com.abc.mxcloneshare.db.AccessDatabase;
import com.abc.mxcloneshare.fragment.FileListFragment;
import com.abc.mxcloneshare.util.AppUtils;
import com.abc.mxcloneshare.util.CommunicationBridge;
import com.abc.mxcloneshare.util.CommunicationNotificationHelper;
import com.abc.mxcloneshare.util.DynamicNotification;
import com.abc.mxcloneshare.util.FileUtils;
import com.abc.mxcloneshare.util.HotspotUtils;
...
import com.abc.mxcloneshare.util.NsdDiscovery;
import com.abc.mxcloneshare.util.TimeUtils;
import com.abc.mxcloneshare.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.abc.mxcloneshare.R;
import com.abc.mxcloneshare.model.NetworkDevice;
import com.abc.mxcloneshare.model.TextStreamObject;
import com.abc.mxcloneshare.model.TransferGroup;
import com.abc.mxcloneshare.model.TransferInstance;
import com.abc.mxcloneshare.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.abc.mxcloneshare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.abc.mxcloneshare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.abc.mxcloneshare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.abc.mxcloneshare.action.IP";
    public static final String ACTION_END_SESSION = "com.abc.mxcloneshare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.com.abc.mxcloneshare.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.abc.mxcloneshare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.abc.mxcloneshare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.abc.mxcloneshare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.abc.mxcloneshare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.abc.mxcloneshare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.abc.mxcloneshare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.abc.mxcloneshare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.abc.mxcloneshare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.abc.mxcloneshare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.abc.mxcloneshare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.abc.mxcloneshare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.abc.mxcloneshare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.abc.mxcloneshare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.abc.mxcloneshare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.abc.mxcloneshare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.abc.mxcloneshare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.abc.mxcloneshare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.abc.mxcloneshare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.abc.mxcloneshare.transaction.action.REQUEST_WEBSHARE_STATUS";
