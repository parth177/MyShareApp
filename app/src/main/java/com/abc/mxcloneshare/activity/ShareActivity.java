...
import com.abc.mxcloneshare.util.OrganizeShareRunningTask;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "com.abc.mxcloneshare.intent.action.TBShare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "com.abc.mxcloneshare.intent.action.TBShare_SEND_MULTIPLE";
